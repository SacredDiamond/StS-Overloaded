...
import Overloadedmod.patches.relics.BottledPlaceholderField;
import Overloadedmod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static Overloadedmod.OverloadedBase.makeRelicOutlinePath;
import static Overloadedmod.OverloadedBase.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = OverloadedBase.makeID("BottledPlaceholderRelic");
