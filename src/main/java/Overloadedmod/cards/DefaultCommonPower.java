...
import Overloadedmod.powers.CommonPower;

import static Overloadedmod.OverloadedBase.makeCardPath;
...
public class DefaultCommonPower extends CustomCard {
    ...
    public static final String ID = OverloadedBase.makeID("DefaultCommonPower");
    ...
    // Go check out DefaultAttackWithVariable and Overloadedmod.variable.DefaultCustomVariable
