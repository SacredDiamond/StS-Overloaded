package Overloadedmod.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import Overloadedmod.cards.AbstractDefaultCard;

import static Overloadedmod.OverloadedBase.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    public String key() {
        ...
        // Remember, we're using makeID so it automatically puts "Overloadedmod:" (or, your id) before the name.
    }
